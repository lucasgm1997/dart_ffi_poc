...
typedef CalculatorSumC =
    ffi.Int32 Function(CalculatorHandle, ffi.Int32, ffi.Int32);
...
typedef CalculatorDivideC =
    ffi.Double Function(CalculatorHandle, ffi.Double, ffi.Double);
typedef CalculatorDivideDart =
    double Function(CalculatorHandle, double, double);

// double calculator_average(CalculatorHandle handle, const double* values, int length);
typedef CalculatorAverageC =
    ffi.Double Function(CalculatorHandle, ffi.Pointer<ffi.Double>, ffi.Int32);
typedef CalculatorAverageDart =
    double Function(CalculatorHandle, ffi.Pointer<ffi.Double>, int);

// double calculator_max(CalculatorHandle handle, const double* values, int length);
typedef CalculatorMaxC =
    ffi.Double Function(CalculatorHandle, ffi.Pointer<ffi.Double>, ffi.Int32);
typedef CalculatorMaxDart =
    double Function(CalculatorHandle, ffi.Pointer<ffi.Double>, int);

// double calculator_min(CalculatorHandle handle, const double* values, int length);
typedef CalculatorMinC =
    ffi.Double Function(CalculatorHandle, ffi.Pointer<ffi.Double>, ffi.Int32);
typedef CalculatorMinDart =
    double Function(CalculatorHandle, ffi.Pointer<ffi.Double>, int);

// const char* calculator_description(CalculatorHandle handle);
typedef CalculatorDescriptionC =
    ffi.Pointer<ffi.Char> Function(CalculatorHandle);
typedef CalculatorDescriptionDart =
    ffi.Pointer<ffi.Char> Function(CalculatorHandle);
...
class CalculatorLib {
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      calculatorNew = _nativeLib
          .lookupFunction<CalculatorNewC, CalculatorNewDart>('calculator_new');
      calculatorFree = _nativeLib
          .lookupFunction<CalculatorFreeC, CalculatorFreeDart>(
            'calculator_free',
          );
      calculatorSum = _nativeLib
          .lookupFunction<CalculatorSumC, CalculatorSumDart>('calculator_sum');

      calculatorProduct = _nativeLib
          .lookupFunction<CalculatorProductC, CalculatorProductDart>(
            'calculator_product',
          );
      calculatorDivide = _nativeLib
          .lookupFunction<CalculatorDivideC, CalculatorDivideDart>(
            'calculator_divide',
          );
      calculatorAverage = _nativeLib
          .lookupFunction<CalculatorAverageC, CalculatorAverageDart>(
            'calculator_average',
          );
      ...
      calculatorDescription = _nativeLib
          .lookupFunction<CalculatorDescriptionC, CalculatorDescriptionDart>(
            'calculator_description',
          );
      calculatorFreeString = _nativeLib
          .lookupFunction<CalculatorFreeStringC, CalculatorFreeStringDart>(
            'calculator_free_string',
          );
      calculatorGetOperationCount = _nativeLib
          .lookupFunction<
            CalculatorGetOperationCountC,
            CalculatorGetOperationCountDart
          >('calculator_get_operation_count');
    } catch (e) {
      _initialized = false;
      throw Exception('Failed to initialize CalculatorLib: $e');
    }
  }
